...
from tmpauth.web.application import get_app
...
from common.sqlalchemy.tests.conftest import (
    sqlalchemy_engine_close,
    sqlalchemy_engine_init,
)
...
services_mocks = {
    ...
    "sqlalchemy_engine": (sqlalchemy_engine_init, sqlalchemy_engine_close),
}
